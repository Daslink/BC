...
/**
 * Test for transaction BDCBT00201COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/BDCBT00201COTest.xml" })
public class BDCBT00201COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(BDCBT00201COTransactionTest.class);
	
	@Autowired
	private BDCBT00201COTransaction transaction;
